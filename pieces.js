...
const PIECES = {
  ...
  // Hexominoes
  'H1': { color: '#7FFFD4', shape: [[1,1,1,1,1,1]], center: [3, 0.5] },
  ...
  'H9': { color: '#ADFF2F', shape: [[1,1,1,0],[0,1,1,1]], center: [1.5, 1] },
  'H10': { color: '#F0E68C', shape: [[1,1,1],[1,1,1]], center: [1.5, 1] },
  ...
  'H18': { color: '#FFF5EE', shape: [[1,1,1,0],[1,0,1,0]], center: [1.5, 1] },
  ...
  'H27': { color: '#FFB6C1', shape: [[0,1,0,0],[1,1,1,1],[0,1,0,0]], center: [1.5, 1] },
  ...
  'H35': { color: '#FAF0E6', shape: [[1,1,0,0],[0,1,1,0],[0,1,1,0]], center: [1.5, 1.5] }
};
